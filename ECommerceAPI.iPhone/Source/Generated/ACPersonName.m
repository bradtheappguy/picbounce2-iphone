/*
	ACPersonName.h
	The implementation of properties and methods for the ACPersonName object.
	Generated by SudzC.com
*/
#import "ACPersonName.h"

@implementation ACPersonName
	...
	+ (ACPersonName*) newWithNode: (CXMLNode*) node
	{
		...
		return (ACPersonName*)[[[ACPersonName alloc] initWithNode: node] autorelease];
	}
	...
	{
		return [self serialize: @"PersonName"];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[ACPersonName class]]) {
